...
//		return "Team Deathmatch"; 
	...
	// FIXMOD_CHANGE - Mehis
	// People need to know that we are still compatible with their client.
	//return "Zombie Master 1.2.1 Open Source"; //LAWYER: REMEMBER!  Change me once each release
	return "Zombie Master 1.2.1 Updated";
}
...
void CHL2MPRules::WorldReset( void )
{
	...
	// FIXMOD_CHANGE - Mehis
	// Messages to dev messages.
	//Msg("Parsing entities...\n"); 
	DevMsg("Parsing entities...\n"); 
...
#ifndef CLIENT_DLL
	// FIXMOD_CHANGE - Mehis
	// Give more descriptive message to the server console.
	Msg( "Round is restarting...\n" );
...
// 		event->SetString("objective","DEATHMATCH");
	...
	{
		g_pZombieGroupManager->m_pZombieLists.Purge();
	}
	else
	{
		Msg( "No zombie group manager found! Can't reset groups!!\n" );
	}
...
// 	}
	...
	*/
	...
	DevMsg("Resetting players to survivor team...\n");
	...
	*/
	...
	DevMsg("Building list of potential ZM players...\n");
	...
	if (pZMPlayer)
	{
		...
		DevMsg("Moving chosen ZM to Zombie Master position...\n");
	...
	DevMsg("Finding a Loadout entity...\n");
	...
	if (pFound)
	{
		...
		if (m_pLoadOut)
		{
			...
			DevMsg("Found a Loadout! Distributing...\n");
