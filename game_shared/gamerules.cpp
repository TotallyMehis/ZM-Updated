...
void CGameRules::CreateStandardEntities()
{
	...
	// FIXMOD_CHANGE - Mehis
	// Create it here...
	g_pZombieGroupManager = (CZombieGroupManager*)CBaseEntity::Create( "zm_group_manager", vec3_origin, vec3_angle );
	g_pZombieGroupManager->AddEFlags( EFL_KEEP_ON_RECREATE_ENTITIES );
}
